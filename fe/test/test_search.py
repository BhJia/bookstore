...
class TestSearch:
    ...
    def test_search(self):
        ...
        assert self.auth.search_book_intro(self.book_intro, "2") == 200
        assert self.auth.search_title(self.title, "1") == 200
        assert self.auth.search_author_in_store("三毛", self.store_id,"2") == 200
        assert self.auth.search_book_intro_in_store(self.book_intro, self.store_id,"1") == 200
        assert self.auth.search_title_in_store(self.title, self.store_id,"2") == 200
